        ...
        <div className="grid grid-cols-[250px_1fr] w-full max-w-[1130px]">
          ...
          <div className="p-10">
            <h1 className="text-2xl font-bold mb-6 text-left">
              Riwayat Pembelian <span>{order.id}</span>
            </h1>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              ...
              {/* Daftar Item */}
              <div className="text-sm space-y-2 border-t pt-4 mt-5">
                ...
                <div className="flex justify-between border-t pt-2 mt-4 font-medium">
                  <span>Subtotal</span>
                  <span>
                    {formatRupiah(
                      orderItems.reduce(
                ...
                <div className="flex justify-between border-t pt-2 font-medium border-b-2">
                  <span>Ongkos Kirim</span>
                  <span>{formatRupiah(order.shipping_cost)}</span>
                </div>
                <div className="flex justify-between border-t pt-2 font-semibold mt-4 text-base border-b-2">
                  <span>Total Harga</span>
                  <span>{formatRupiah(order.total_price)}</span>
                </div>
                <div
                  className={`flex mt-4 justify-between font-semibold ${
